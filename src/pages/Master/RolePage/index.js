...
import { fetchRoles, getRoleById, addRole, updateRole, updatePermissions, deleteRole } from "../../../actions/roleAction";
...
const RolePage = (props) => {
  const { role, roles, isLoading, fetchRoles, getRoleById, addRole, updateRole, updatePermissions, deleteRole, total_data, fetchPermissions, permissions, isLoadingPermission, permissionsss } = props;
  ...
  return (
    <div class="page-wrapper">
                  ...
                  <div class="card-header ">
                    <div class="row w-full">
                      <div class="col-md-9 col-12">
                        ...
                        <p class="text-secondary m-0">Master Role di Booking Room</p>
                      </div>
                          ...
                          {isLoading
                            ...
                            : paginatedItems?.map((role, index) => (
                                <tr key={role?.id}>
                                  ...
                                  <td className="sort-city">{role?.description}</td>
      ...
      <FormRole isShowModal={isShowModal} isEdit={isEdit} closeModal={closeModal} formState={formState} setFormState={setFormState} handleAdd={handleAdd} handleUpdate={handleUpdate} handleUpdateRole={handleUpdateRole} />
      <FormPermissionPicker isShowModal={isShowModal} isEdit={isEdit} closeModal={closeModal} formState={formState} setFormState={setFormState} handleAdd={handleAdd} handleUpdate={handleUpdate} fetchPermissions={fetchPermissions} permissions={permissions} isLoadingPermission={isLoadingPermission} handleCheckboxChange={handleCheckboxChange} handleCheckAll={handleCheckAll} />
