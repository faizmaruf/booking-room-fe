...
import { fetchProvinces, addProvince } from "../../../actions/regionAction/provinceAction";
import { connect } from "react-redux";
import ModalDelete from "../../../components/Modals/ModalDelete";
import OverlayLoading from "../../../components/Loading/OverlayLoading";

const ProvincePage = (props) => {
  const { regions, provinces, isLoading, fetchProvinces, addProvince } = props;
                  ...
                  <div class="card-header ">
                    <div class="row w-full">
                      <div class="col-md-9 col-12">
                        ...
                        <p class="text-secondary m-0">Master wilayah provinsi di Booking Room</p>
                      </div>
                      ...
                      <table class="table table-vcenter table-selectable">
                        ...
                        <tbody className="table-tbody">
                          {isLoading
                            ...
                            : paginatedItems?.map((province, index) => (
                                <tr key={province.id}>
                                  <td className="sort-name">{(currentPage - 1) * perPage + index + 1}.</td>
                                  <td className="sort-name">{province?.id}</td>
                                  <td className="sort-city">{province?.name}</td>
...
const mapStateToProps = (state) => ({
  ...
  isLoading: state?.regions?.provinces?.loading,
});
