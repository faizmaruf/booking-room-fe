...
const PartnershipPage = () => {
  ...
  return (
    <div class="page-wrapper">
      <div class="page-header d-print-none">
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            <div class="col">
              <div class="page-pretitle">Rekanan </div>
              <h2 class="page-title">Partnership dan Kerjasama</h2>
            </div>
      ...
      <FormPartnership isShowModal={isShowModal} closeModal={closeModal} />
    </div>
  );
};
